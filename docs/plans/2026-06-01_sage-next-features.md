...
- [x] 步骤 1：安装 remark-gfm 依赖
- [x] 步骤 2：Message.tsx 代码高亮 + 复制按钮
- [x] 步骤 3：Sidebar.tsx 集成 SessionList/SessionItem
- [x] 步骤 4：Settings 连接测试增强（chat completion 验证）
- [x] 步骤 5：Memory 页面假按钮修复 + 真实 Stats
- [x] 步骤 6：Tauri 后端启动失败 UI 处理
- [x] 步骤 7：LLM 错误分类与友好提示
- [x] 步骤 8：修复 agent.py except 块 bug
- [x] 步骤 9：工具 schema 发送到 LLM
- [x] 步骤 10：ReAct 循环实现
- [x] 步骤 11：工具执行结果 UI 展示
- [x] 步骤 12：推送 GitHub，追踪 CI，修复问题
