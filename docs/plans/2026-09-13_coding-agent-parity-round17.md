...
| 批次 | main | win7 |
| --- | --- | --- |
| A（collect 超时返回部分聚合） | PR #731（squash 775a61ce） | PR #736（cherry-win7-r17，squash 8107d8e3） |

win7 对齐说明：零冲突落位；py3.8 纪律照旧；本地 ruff 全过 + partial 3 例绿后由 CI（含 py3.8 job）终验，squash merge（#736）。
