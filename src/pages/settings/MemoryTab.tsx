 ...
 *
 * 治理记录:
 * - "同步到内部服务器" 死开关 (memoryServerSync) 已于 2026-09-18 移除——
 *   后端下线该字段, 前端每次 PUT 主动剥离, 开关永远不生效。
 * - 不硬编码展示记忆库路径: 实际路径由 SAGE_DB_PATH 环境变量与运行模式
 *   决定 (见 backend/data/database.py), 写死展示既不准也无用。
 */
