...
const SAMPLE_TREND: UsageTrend = {
  ...
  bucket: 'hour',
  series: [
    { ts: '2026-09-09T00:00:00Z', requests: 1, cost_usd: 0.001 },
    { ts: '2026-09-09T06:00:00Z', requests: 5, cost_usd: 0.005 },
    { ts: '2026-09-09T12:00:00Z', requests: 12, cost_usd: 0.012 },
    { ts: '2026-09-09T18:00:00Z', requests: 8, cost_usd: 0.008 },
  ],
};
...
describe('UsageTrendChart', () => {
  ...
  it('bucket=day 时中点 tick 留空 (避免 X 轴拥挤)', () => {
    const dayTrend: UsageTrend = {
      ...
      bucket: 'day',
      series: [
        { ts: '2026-08-10T00:00:00Z', requests: 2, cost_usd: 0.002 },
        { ts: '2026-08-25T00:00:00Z', requests: 4, cost_usd: 0.004 },
        { ts: '2026-09-09T00:00:00Z', requests: 6, cost_usd: 0.006 },
      ],
    };
