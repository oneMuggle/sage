 ...
 * 会话列表渲染组件。
 *
 * 历史沿革: 早期版本包了 @dnd-kit 拖拽层,用户拖拽顺序持久化到 localStorage
 * 覆盖后端默认序。2026-09-21 改为完全依赖后端排序:置顶 > 活跃(running/suspended)
 * > 时间降序。前端不再接收 order prop,也无 onOrderChange,排序由后端
 * `SessionRepository.list()` 在 SQL 层完成。
 */
