...
export const zh = {
  ...
  'chat.send': '发送',
  // U5 (2026-09-18): 运行中发送 = 插话或排队；待发送队列可见可操作
  'chat.send_while_running': '排队',
  'chat.queue_title': '待发送',
  'chat.queue_paused': '队列已暂停 — 上一轮未正常结束',
  'chat.queue_resume': '继续发送',
  'chat.queue_clear': '清空',
  'chat.queue_send_now': '立即发送',
  'chat.queue_edit': '编辑',
  'chat.queue_top': '置顶',
  'chat.queue_remove': '删除',
  'chat.steering_badge': '已插话 · 下一轮生效',
  // P2-a (2026-09-20): 三条投递通道。调研结论 —— "时序不透明"才是排队被
  // 投诉的主因，所以每条通道都要在菜单里写清"什么时候生效"。
  'chat.delivery_menu': '发送方式',
  'chat.delivery_steer': '插话',
  'chat.delivery_steer_short': '插话',
  'chat.delivery_steer_hint': '不打断当前回复，在下一个迭代边界注入给 AI',
  'chat.delivery_queue': '排队',
  'chat.delivery_queue_short': '排队',
  'chat.delivery_queue_hint': '等本轮回复完整结束后，作为新的一条自动发送',
  'chat.delivery_interrupt': '打断并发送',
  'chat.delivery_interrupt_short': '打断并发送',
  'chat.delivery_interrupt_hint': '立刻停止当前回复，按这条重新开始',
  // Wave 3 C6: 编排模式条
  ...
  // ─── R19: 网页访问拦截卡片 ───────
  'chat.blocked.title': '网页访问被拦截',
  'chat.blocked.target': '目标',
  'chat.blocked.suggestions': '建议操作',
  'chat.blocked.reason.antibot_cf': 'Cloudflare 反爬验证',
  'chat.blocked.reason.antibot_other': '反爬风控拦截',
  'chat.blocked.reason.login_wall': '需要登录',
  'chat.blocked.reason.http_4xx': '请求被拒绝',
  'chat.blocked.reason.http_5xx': '服务端错误',
  'chat.blocked.reason.timeout': '请求超时',
  'chat.blocked.reason.dns': '域名解析失败',
  'chat.blocked.reason.render': '动态渲染失败',
  'chat.blocked.reason.generic': '访问失败',
  'chat.blocked.action.open_browser': '用浏览器打开',
  'chat.blocked.action.configure_credentials': '配置登录凭据',
  'chat.blocked.action.configure_proxy': '配置代理',
  'chat.blocked.action.view_docs': '查看文档',
  'chat.loading': '正在加载对话...',
  ...
  'chat.perm.standard': '标准',
  'chat.perm.standard.desc': '工作区内读写不问；执行命令与越界操作需确认',
  'chat.perm.auto': '自动',
  'chat.perm.auto.desc': '放行全部操作；仅删除/覆盖等破坏性命令仍需确认',
  'chat.perm.custom': '自定义',
  'chat.perm.applied': '已切换，下一次工具调用起生效',
  'chat.perm.failed': '切换权限模式失败',
  'chat.perm.auto_count': '已自动批准 {n} 次',
  'chat.perm.audit_title': '本会话自动放行的操作',
  'chat.perm.audit_empty': '本会话还没有自动放行的写入/执行操作',
  'chat.perm.destructive_note': '任何档位下，rm -rf / 强制覆盖等破坏性命令都会弹出确认。',
  'chat.nav.opened': '已打开 {page}',
  'chat.atEntity.label': '引用',
  'chat.atEntity.memory': '记忆',
  'chat.atEntity.memory.desc': '@memory:关键词 —— 把匹配的长期记忆注入本条消息',
  'chat.atEntity.wiki': 'Wiki',
  'chat.atEntity.wiki.desc': '@wiki:关键词 —— 引用知识库 Wiki 页面',
  'chat.atEntity.skill': '技能',
  'chat.atEntity.skill.desc': '@skill:名称 —— 提示模型使用该技能',
  ...
  'tplfill.title': '填写模板变量',
  'tplfill.subtitle': '以下占位将替换为你填写的值；留空则保留 {{占位}}',
  ...
  'wizard.step2': '地址与密钥',
  'wizard.step3': '测试连接',
  'wizard.proto.openai': 'OpenAI 兼容',
  'wizard.proto.anthropic': 'Anthropic',
  'wizard.proto.gemini': 'Gemini',
  'wizard.proto.ollama': 'Ollama（本地）',
  'wizard.next': '下一步',
  'wizard.back': '上一步',
  'wizard.baseurl': '服务地址 (Base URL)',
  'wizard.apikey': 'API 密钥',
  'wizard.save_direct': '直接保存',
  'wizard.test': '测试连接',
  'wizard.pick_model': '选择对话模型',
  'wizard.pick_model_hint': '暂不选择（可稍后在设置中指定）',
  'wizard.skip_test_hint': '该协议请直接保存，连接测试可在设置页进行',
  'wizard.save': '保存并完成',
  'wizard.skip': '跳过，稍后在设置中配置',
  'wizard.done.title': '配置完成',
  'wizard.done.desc': '端点已保存并设为对话模型。之后可随时在 设置 → 服务端点 中修改。',
  'wizard.done.start': '开始使用 Sage',
  'chat.attachment_not_sent':
    '提示：普通文件附件暂不随消息发送（即将支持）；图片可直接发送，@ 引用的文件会生效',
  ...
  'settings.search.hits': '匹配 {count} 项',
  'settings.search.empty': '没有匹配的设置项',
  'settings.section.network.access': '访问控制',
  'settings.section.network.fetch': '抓取与搜索',
  ...
  'settings.network.proxy': '抓取代理',
  'settings.network.proxy.hint':
    '网页抓取与内置浏览器出网时使用。留空 = 不启用；支持 http://、https://、socks5://。',
  'settings.network.proxy.http': 'HTTP 代理',
  'settings.network.proxy.https': 'HTTPS 代理',
  'settings.network.proxy.placeholder': 'http://127.0.0.1:7890（留空 = 不启用）',
  'settings.network.proxy.error.scheme': '代理地址需以 http://、https:// 或 socks5:// 开头',
  'settings.network.creds': '网站凭据',
  'settings.network.creds.hint':
    'browser_cookies 导出的登录态（加密存储，不回显内容）。供静态抓取、JS 渲染与浏览器通道共用。',
  'settings.network.creds.empty': '暂无凭据。让助手在浏览器里登录后执行 browser_cookies 导出。',
  'settings.network.creds.delete': '删除',
  'settings.network.creds.expired': '已过期',
  'settings.network.creds.browser': '浏览器',
  'settings.network.creds.browser.missing': '未发现可用浏览器（JS 渲染与浏览器通道不可用）',
  'settings.network.creds.add_header': '新增 header 凭据（Bearer / API key）',
  'settings.network.creds.add_header.domain': '域名（如 .api.example.com）',
  'settings.network.creds.add_header.name': '头名（如 Authorization）',
  'settings.network.creds.add_header.value': '头值',
  'settings.network.creds.add_header.save': '保存',
  'settings.network.creds.add_header.invalid': '保存失败：域名 / 头名 / 头值不合法',
  'settings.network.creds.add_cookie.label': '新增 cookie 凭据',
  'settings.network.creds.add_cookie.domain': '域名（如 .example.com）',
  'settings.network.creds.add_cookie.value': 'Cookie（如 session=abc; theme=dark）',
  'settings.network.creds.add_cookie.save': '保存',
  'settings.network.creds.add_cookie.invalid': 'Cookie 格式无效，未保存',
  'settings.network.creds.add_cookie.failed': 'Cookie 保存失败，请稍后重试',
  'settings.network.creds.metrics': '出网指标（本进程内）',
  'settings.network.creds.metrics.ok': '成功',
  'settings.network.creds.metrics.fail': '失败',
  'settings.network.creds.metrics.escalated': '升级渲染',
  'settings.network.creds.metrics.avg': '均耗时',
  ...
  'settings.network.creds.render_persistent': 'JS 渲染使用持久 profile',
  'settings.network.creds.render_persistent.desc':
    '登录后的 SPA 页面经渲染通道直接可读（登录态跨会话保留）',
  'settings.network.creds.auto_refresh': '登录态自动刷新',
  'settings.network.creds.auto_refresh.desc': '凭据失效时用来源 profile 静默重导并重放一次',
  'settings.network.search': '搜索引擎',
  'settings.network.search.hint':
    '按顺序尝试：首选引擎无结果时自动回退后续引擎。API 引擎未填 key 时自动跳过。',
  'settings.network.search.first': '首选引擎',
  'settings.network.search.tavily_key': 'Tavily API Key',
  'settings.network.search.zhipu_key': '智谱 API Key',
  'settings.network.search.key.placeholder': '留空 = 不启用该引擎（落库自动加密）',
  'settings.network.search.engine.bing': 'Bing（默认，大陆可达）',
  'settings.network.search.engine.ddg': 'DuckDuckGo（后备）',
  'settings.network.search.engine.tavily': 'Tavily（需 API Key）',
  ...
  'settings.mcp.add.transport': '传输方式',
  'settings.mcp.add.url': 'HTTP 端点 URL',
  'settings.mcp.add.headers': '请求头（JSON 对象，可选）',
  'settings.mcp.error.url_invalid': '请输入有效的 HTTP 或 HTTPS URL。',
  'settings.mcp.error.args_invalid':
    '参数必须为 JSON 字符串数组；每一项为一个参数，保留空格和空字符串。',
  'settings.mcp.error.headers_invalid': '请求头必须为值均为字符串的 JSON 对象。',
  'settings.mcp.add.title': '添加服务器',
  'settings.mcp.add.name': '名称',
  'settings.mcp.add.command': '命令',
  'settings.mcp.add.args': '参数（JSON 字符串数组）',
  ...
  // 项目概览与资料 (M3, 2026-09-18)
  'sider.project.materials_load_failed': '加载项目资料失败：{message}',
  'sider.project.overview_saved': '项目概览已保存',
  'sider.project.overview_save_failed': '保存项目概览失败：{message}',
  'sider.project.material_too_large': '资料内容过长（上限 64KB）',
  'sider.project.material_add_failed': '添加项目资料失败：{message}',
  'sider.project.material_remove_failed': '移除项目资料失败：{message}',
  'sider.project.save_answer_no_session': '当前未选中会话',
  'sider.project.save_answer_no_assistant': '当前会话暂无助手回答',
  'sider.project.save_answer_ok': '已保存为项目资料',
  'sider.project.save_answer_mismatch': '该会话不属于此项目，无法保存',
  'sider.project.save_answer_not_found': '消息不存在',
  'sider.project.save_answer_failed': '保存资料失败：{message}',
  'sider.project.overview_title': '项目概览',
  'sider.project.overview_saving': '保存中…',
  'sider.project.overview_save': '保存',
  'sider.project.overview_description': '项目描述',
  'sider.project.overview_description_placeholder': '一句话描述项目目标与定位…',
  'sider.project.overview_instructions': '项目指令',
  'sider.project.overview_instructions_placeholder': '为该项目设定的专属提示词（注入提示词开头）…',
  'sider.project.materials_title': '项目资料',
  'sider.project.save_answer_title': '保存当前回答为资料',
  'sider.project.save_answer': '保存当前回答',
  'sider.project.materials_loading': '加载资料中…',
  'sider.project.material_from_message': '来自会话回答',
  'sider.project.material_direct': '手动录入',
  'sider.project.material_remove': '移除资料',
  'sider.project.materials_empty': '暂无项目资料，可在下方录入或一键保存回答',
  'sider.project.material_input_placeholder': '输入关键上下文、参考资料或约定…',
  'sider.project.material_add': '添加资料',
  'sider.project.material_status_ready': '就绪',
  'sider.project.material_status_pending': '处理中',
  'sider.project.material_status_failed': '失败',
  ...
  'permission.project_allow.tooltip': '将此路径加入当前项目的允许访问列表',
  'permission.project_allow.added': '已添加规则 {rule}',
  'permission.project_allow.no_project': '未找到当前工作区对应的项目',
  'permission.project_allow.failed': '添加允许规则失败',
  'codeBlock.copy': '复制',
  ...
  'settings.font.sizeUi': '界面字号',
  'settings.font.sizeCode': '代码字号',
  'settings.font.reset': '恢复默认字体',
  'settings.font.preview': '字体预览：你好，世界！Hello, world!',
  ...
  'office.generate.pptLayout': '版式',
  'office.generate.layoutTitleContent': '标题+内容',
  'office.generate.layoutTitle': '仅标题',
  'office.generate.layoutBlank': '空白',
  ...
  'office.edit.kindAddChart': '插入图表',
  'office.edit.chartType': '图表类型',
  'office.edit.chartAnchor': '锚点单元格',
  'office.edit.chartMinCol': '数据起始列',
  'office.edit.chartMinRow': '数据起始行',
  'office.edit.chartMaxCol': '数据结束列',
  'office.edit.chartMaxRow': '数据结束行',
  'office.edit.chartTitle': '图表标题（可选）',
  'office.edit.kindSetColumnWidth': '设置列宽',
  'office.edit.kindSetFill': '单元格填充',
  'office.edit.kindFreezePanes': '冻结窗格',
  'office.edit.colWidthColumn': '列（如 A）',
  'office.edit.colWidthValue': '宽度',
  ...
  'office.form.loading': '正在读取字段…',
  'office.form.noFields': '该 PDF 没有可填写的表单字段',
  'office.form.readOnly': '只读',
  'office.form.flatten': '提交后拍平（不可再编辑）',
  'office.form.fill': '填写并生成副本',
  'office.form.filling': '正在填写…',
  'office.form.fillSuccess': '表单已填写',
  'office.form.fillFailed': '表单填写失败',
