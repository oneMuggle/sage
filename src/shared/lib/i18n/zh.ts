...
export const zh = {
  ...
  'office.preview.formulasNote': '缓存值缺失 — 仅显示公式文本',
  'office.preview.rowsTruncated': '…{n} 行已隐藏',
  'office.preview.paragraphsTruncated': '…{n} 段已隐藏',
  'office.preview.cellsTruncated': '…{n} 列已隐藏',
  ...
  // ─── M6 生态扩展: Office 编辑/导出/模板/批量 ─────
  'office.edit.title': '编辑预览',
  'office.edit.open': '编辑预览',
  'office.edit.close': '关闭',
  'office.edit.composeHint': '编写简单编辑并预览（不会修改文档）',
  'office.edit.wordFind': '查找文本',
  'office.edit.wordFindPlaceholder': '要替换的文本…',
  'office.edit.wordReplace': '替换为',
  'office.edit.wordReplacePlaceholder': '替换文本（留空则删除）',
  ...
  'office.edit.pptSlideNumber': '幻灯片编号',
  'office.edit.pptTitle': '新标题',
  'office.edit.preview': '预览变更',
  'office.edit.previewing': '正在生成预览…',
  'office.edit.changes': '变更预览',
  'office.edit.before': '变更前',
  'office.edit.after': '变更后',
  'office.edit.truncated': '变更较多 — 仅显示前 200 条',
  'office.edit.previewFailed': '预览失败',
  'office.edit.rejected': '无法应用此编辑',
  'office.edit.noChanges': '未产生变更',
  'office.edit.required': '请填写编辑字段',
  'office.edit.apply': '应用变更',
  'office.edit.applying': '正在应用…',
  'office.edit.applyHint': '确认无误？应用后会将上述变更写入文档。',
  'office.edit.applied': '已应用编辑',
  'office.edit.applyFailed': '应用失败',
  'office.edit.selfCheckOk': '自检通过',
  'office.edit.selfCheckFailed': '自检失败',
  'office.edit.selfCheckParagraphs': '{n} 个段落',
  'office.edit.selfCheckTables': '{n} 个表格',
  'office.edit.selfCheckSheets': '{n} 个工作表',
  'office.edit.selfCheckSlides': '{n} 张幻灯片',
  'office.edit.selfCheckPages': '{n} 页',
  'office.export.pdf': '导出 PDF',
  'office.export.exporting': '正在导出…',
  'office.export.success': 'PDF 已导出',
  'office.export.failed': '导出失败',
  'office.export.noConverter': '未找到本地转换器（需要 LibreOffice 或 MS Word）',
  'office.export.openFolder': '显示所在文件夹',
  'office.template.modeFreeform': '自由格式',
  'office.template.modeTemplate': '从模板创建',
  'office.template.pickTitle': '选择模板',
  'office.template.loading': '正在加载模板…',
  'office.template.loadFailed': '加载模板失败',
  ...
  'office.template.hint.rich': '支持 {{ }} 富文本或表格变量，具体以模板定义为准',
  'office.template.hint.image': '仅限模板内的图片变量；留空跳过',
  'office.template.create': '创建文档',
  'office.template.creating': '正在创建…',
  'office.template.success': '已从模板创建',
  'office.template.failed': '创建失败',
  'office.template.selectFirst': '请先选择模板',
  'office.template.unfilled': '未填充的占位符',
  'office.batch.archive': '归档所选',
  'office.batch.restore': '恢复所选',
  'office.batch.start': '批量操作已开始…',
  'office.batch.done': '批量完成：{n} 项',
  'office.batch.doneWithFailures': '批量完成：{n} 项成功，{m} 项失败',
