...
export const en: Record<TranslationKey, string> = {
  ...
  'settings.network.creds.empty': 'No credentials yet. Ask the assistant to log in and run browser_cookies export.',
  ...
  'settings.network.creds.render_persistent.desc': 'Login-walled SPA pages readable via the render channel (state survives restarts)',
  'settings.network.creds.auto_refresh': 'Auto-refresh login state',
  'settings.network.creds.auto_refresh.desc': 'Silently re-export credentials from the source profile when they expire',
