...
export const en: Record<TranslationKey, string> = {
  ...
  'chat.send': 'Send',
  // U5 (2026-09-18): sending while running = steer or queue; visible pending queue
  'chat.send_while_running': 'Queue',
  'chat.queue_title': 'Pending',
  'chat.queue_paused': 'Queue paused — last run did not finish cleanly',
  'chat.queue_resume': 'Resume',
  'chat.queue_clear': 'Clear',
  'chat.queue_send_now': 'Send now',
  'chat.queue_edit': 'Edit',
  'chat.queue_top': 'Move to top',
  'chat.queue_remove': 'Remove',
  'chat.steering_badge': 'Steered · applies next iteration',
  // P2-a (2026-09-20): delivery channels — each label states when it takes effect.
  'chat.delivery_menu': 'Send as',
  'chat.delivery_steer': 'Steer',
  'chat.delivery_steer_short': 'Steer',
  'chat.delivery_steer_hint': "Don't stop the run — inject at the next iteration",
  'chat.delivery_queue': 'Queue',
  'chat.delivery_queue_short': 'Queue',
  'chat.delivery_queue_hint': 'Send automatically after this reply finishes',
  'chat.delivery_interrupt': 'Interrupt & send',
  'chat.delivery_interrupt_short': 'Interrupt',
  'chat.delivery_interrupt_hint': 'Stop this reply and start over with your message',
  ...
  // ─── R19: web access blocked card ───────
  'chat.blocked.title': 'Web access blocked',
  'chat.blocked.target': 'Target',
  'chat.blocked.suggestions': 'Suggested actions',
  'chat.blocked.reason.antibot_cf': 'Cloudflare bot check',
  'chat.blocked.reason.antibot_other': 'Anti-bot protection',
  'chat.blocked.reason.login_wall': 'Login required',
  'chat.blocked.reason.http_4xx': 'Request rejected',
  'chat.blocked.reason.http_5xx': 'Server error',
  'chat.blocked.reason.timeout': 'Request timed out',
  'chat.blocked.reason.dns': 'DNS resolution failed',
  'chat.blocked.reason.render': 'Dynamic render failed',
  'chat.blocked.reason.generic': 'Access failed',
  'chat.blocked.action.open_browser': 'Open in browser',
  'chat.blocked.action.configure_credentials': 'Configure credentials',
  'chat.blocked.action.configure_proxy': 'Configure proxy',
  'chat.blocked.action.view_docs': 'View docs',
  ...
  'settings.search.hits': '{count} matches',
  'settings.search.empty': 'No matching settings',
  'settings.section.network.access': 'Access control',
  'settings.section.network.fetch': 'Fetching & search',
  'settings.network.creds': 'Site credentials',
  'settings.network.creds.hint':
    'Login state exported via browser_cookies (encrypted, never echoed). Shared by static fetch, JS render and browser channels.',
  'settings.network.creds.empty':
    'No credentials yet. Ask the assistant to log in and run browser_cookies export.',
  ...
  'settings.network.creds.add_header.value': 'Header value',
  'settings.network.creds.add_header.save': 'Save',
  'settings.network.creds.add_header.invalid': 'Save failed: invalid domain / header name / value',
  'settings.network.creds.add_cookie.label': 'Add cookie credential',
  'settings.network.creds.add_cookie.domain': 'Domain (e.g. .example.com)',
  'settings.network.creds.add_cookie.value': 'Cookie (e.g. session=abc; theme=dark)',
  'settings.network.creds.add_cookie.save': 'Save',
  'settings.network.creds.add_cookie.invalid': 'Invalid cookie format; nothing was saved',
  'settings.network.creds.add_cookie.failed': 'Failed to save cookies. Please try again later.',
  'settings.network.creds.metrics': 'Egress metrics (this process)',
  'settings.network.creds.metrics.ok': 'ok',
  'settings.network.creds.metrics.fail': 'fail',
  ...
  'settings.network.creds.render_persistent': 'Persistent profile for JS rendering',
  'settings.network.creds.render_persistent.desc':
    'Login-walled SPA pages readable via the render channel (state survives restarts)',
  'settings.network.creds.auto_refresh': 'Auto-refresh login state',
  'settings.network.creds.auto_refresh.desc':
    'Silently re-export credentials from the source profile when they expire',
  ...
  'office.generate.pptLayout': 'Layout',
  'office.generate.layoutTitleContent': 'Title + content',
  'office.generate.layoutTitle': 'Title only',
  'office.generate.layoutBlank': 'Blank',
  ...
  'office.edit.kindAddChart': 'Insert chart',
  'office.edit.chartType': 'Chart type',
  'office.edit.chartAnchor': 'Anchor cell',
  'office.edit.chartMinCol': 'Data first column',
  'office.edit.chartMinRow': 'Data first row',
  'office.edit.chartMaxCol': 'Data last column',
  'office.edit.chartMaxRow': 'Data last row',
  'office.edit.chartTitle': 'Chart title (optional)',
  'office.edit.kindSetColumnWidth': 'Set column width',
  'office.edit.kindSetFill': 'Cell fill',
  'office.edit.kindFreezePanes': 'Freeze panes',
  'office.edit.colWidthColumn': 'Column (e.g. A)',
  'office.edit.colWidthValue': 'Width',
