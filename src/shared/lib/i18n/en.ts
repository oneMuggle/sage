...
export const en: Record<TranslationKey, string> = {
  ...
  // ─── R53 extended: Excel/PPT edit operations ─────
  ...
  'office.edit.freezeCell': 'Freeze panes up to this cell',
  ...
  'office.edit.kindSetCells': 'Set cells',
  ...
  'office.edit.rows': 'Row data (one per line, cells comma-separated)',
  // ─── R53 extended: preview & formulas ─────
  ...
  'office.preview.imagesOmitted': '{n} more images not inlined (too large or over limit)',
  'office.preview.imagesTitle': 'Document images',
  'office.preview.loadingMore': 'Loading…',
  'office.preview.loadMore': 'Load more',
  'office.preview.loadMorePages': 'Load more ({n} pages remaining)',
  'office.preview.originalFailed': 'Original preview failed',
  'office.preview.originalView': 'Original view',
  'office.preview.pageNumberField': 'Contains page number field',
  'office.preview.structuredView': 'Structured view',
  'office.preview.tocFields': 'Table of contents fields',
  'office.recalc.button': 'Refresh formula cache',
  'office.recalc.failed': 'Formula recalculation failed',
