...
export const en: Record<TranslationKey, string> = {
  ...
  'settings.network.browser_env': 'Browser environment',
  'settings.network.browser_env.hint':
    'Check local browser availability, Win7 prerequisites, and CDP handshake status.',
  'settings.network.browser_env.refresh': 'Re-check',
  'settings.network.browser_env.recommended': 'Recommended',
  'settings.network.browser_env.loading': 'Checking…',
  'settings.network.browser_env.error': 'Check failed. Make sure the backend service is running.',
  'settings.network.browser_env.status.pass': 'Pass',
  'settings.network.browser_env.status.warn': 'Warning',
  'settings.network.browser_env.status.fail': 'Fail',
  'settings.network.browser_env.status.na': 'N/A',
  'settings.network.browser_env.fix': 'Fix',
