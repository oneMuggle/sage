...
class TestHashEmbedder:
    ...
    def test_similar_texts_have_close_vectors(self):
        ...
        # 计算欧氏距离（向量已 L2 归一化）
        d_similar = sum((a - b) ** 2 for a, b in zip(v1, v2)) ** 0.5  # noqa: B905 — zip strict= 是 3.10+ 形参
        d_different = sum((a - b) ** 2 for a, b in zip(v1, v3)) ** 0.5  # noqa: B905 — zip strict= 是 3.10+ 形参
